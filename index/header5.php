                    ...
                    <div class="col-megamenu">
                      ...
                      <ul class="list-unstyled">
                        ...
                        if (!isset($_SESSION['ibm']) || $_SESSION['ibm'] === 58998 || $_SESSION['ibm'] === 51947 || $_SESSION['ibm'] === 22622 || $_SESSION['ibm'] === 55268 || $_SESSION['ibm'] === 53224) {
                          ?>
                          <hr class="dropdown-divider">
                          <li><a class="dropdown-item" href="../Vacaciones/validarVacaciones">Validación/Corrección en solicitudes de vacaciones</a></li>
                  ...
                  <div class="col-lg-4 col-6">
                    <div class="col-megamenu">
                      ...
                      <ul class="list-unstyled">
                        ...
                        <li><a class="dropdown-item" href="../SalaJuntas/salasReservadas">Salas Reservadas</a></li>
