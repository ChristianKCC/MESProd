                      ...
                      <ul class="list-unstyled">
                        ...
                        <?php
                            if (session_status() == PHP_SESSION_NONE)
                              session_start();
                            if (!isset($_SESSION['ibm']) || $_SESSION['ibm'] === 58998 || $_SESSION['ibm'] === 51947 || $_SESSION['ibm'] === 22622 || $_SESSION['ibm'] === 55268) {
                        ?>                          
                        ...
                        if (!isset($_SESSION['ibm']) || $_SESSION['ibm'] === 58998 || $_SESSION['ibm'] === 51947 || $_SESSION['ibm'] === 22622 || $_SESSION['ibm'] === 55268) {
                          ?>
                          <hr class="dropdown-divider">
                          <li><a class="dropdown-item" href="../Vacaciones/validarVacaciones">Validación/Corección en solicitudes de vacaciones</a></li>
                          <li><a class="dropdown-item" href="../Tiempoextra/validarTiempoExtra">Validación/Corección en solicitudes de tiempos extras</a></li>
                            <?php
                        } 
                        ?>                      
                        <hr class="dropdown-divider">
                    ...
                    <div class="col-megamenu">
                      ...
                      <ul class="list-unstyled">
                        ...
                        <?php
                          if (session_status() == PHP_SESSION_NONE)
                            session_start();
                          if (!isset($_SESSION['ibm']) || $_SESSION['ibm'] === 58998 || $_SESSION['ibm'] === 22622 || $_SESSION['ibm'] === 55268 || $_SESSION['ibm'] === 51947) {
                            ?>                          
