                    ...
                    <div class="col-megamenu">
                      ...
                      <ul class="list-unstyled">
                        ...
                        if (session_status() == PHP_SESSION_NONE)
                          session_start();
                        if (!isset($_SESSION['ibm']) || $_SESSION['ibm'] === 58998 || $_SESSION['ibm'] === 51947 || $_SESSION['ibm'] === 22622) {
                          ?>
                          <li><a class="dropdown-item" href="../Vacaciones/upload">Actualización del Archivo de
                              Vacaciones</a></li>
                          <?php
                        }
                        ?>
                        ...
                        if (!isset($_SESSION['ibm']) || $_SESSION['ibm'] === 58998 || $_SESSION['ibm'] === 51947 || $_SESSION['ibm'] === 22622) {
                          ?>
                          <li><a class="dropdown-item" href="../Vacaciones/autorizar">Autoriza/Rechaza Solicitudes
                              Pendientes de Vacaciones</a></li>
                          <?php
                        }
                        ?>
                        ...
                        <li><a class="dropdown-item" href="../Vacaciones/Consulta">Consulta y Solicita tus
                            Vacaciones</a></li>
                        <!--
                        <li><a class="dropdown-item" href="../Vacaciones/reporte">Reporte Vacaciones</a></li>
                        -->
                        <hr class="dropdown-divider">
                        ...
                        <li><a class="dropdown-item" href="../Tiempoextra/index.php">Tiempo Extra</a></li>
                        <li><a class="dropdown-item" href="../Tiempoextra/Autorizatp">Autoriza Tiempo Extra</a></li>
                        <li><a class="dropdown-item" href="../Cambiopuesto/index.php">Cambio de Puesto</a></li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-lg-4 col-6">
                  ...
                  <div class="col-lg-4 col-6">
                    <div class="col-megamenu">
                      ...
                      <ul class="list-unstyled">
                        ...
                        <li><a class="dropdown-item" href="../Tiempoextra/reportegenral.php">Reporte Tiempo Extra</a>
                        </li>
