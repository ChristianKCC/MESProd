...
$queryal = "SELECT
    ...
    -- Tomar el turno que más veces aparece para ese empleado/folio/maquina
    (SELECT TOP 1 turnoAsignado 
     FROM TiempoextraSubEnc t2 
     WHERE t2.noemp = TiempoextraSubEnc.noemp 
       AND t2.folio = $folio 
       AND t2.maquina = TiempoextraSubEnc.maquina
     GROUP BY turnoAsignado 
...
// $autorizo == 1 && $pdf->Image('../firmas/'.$autorizoemp.'.JPG', $x+20, $y-12, 13);
