...
$conn = $ClassConexion->conexion("TLX004MXDB");

$query = "SELECT ibm FROM tblMXPRPermisos WHERE tipo = 1";
...
require_once(__DIR__ . "/Kardex/CargarKardex/LogicaUploadKardex.php");
...
<body>
  ...
  <div class="container p-4">
    <h5 class="tittlecont">Actualización de archivo excel para 'Kárdex'</h5>
    <br /><br />
    ...
    <div class="row">
      <div class="col-20">
        <small class="alert alert-info">
          ...
          Sube el archivo <strong>Excel (.xlsx)</strong> o <strong>CSV (.csv)</strong> y pega el <strong>enlace de Excel
            Online</strong>. El archivo y el enlace anteriores serán reemplazados automáticamente.
        </small>
      </div>
    </div>
    <br />
    ...
    <div class="emc-page">
        ...
        <div class="emc-card-title d-flex justify-content-between align-items-center">
          ...
          <?php if ($fileExists): ?>
            <div class="d-flex gap-2 flex-wrap ms-auto">
              <a href="Kardex.php" class="emc-btn emc-btn-primary emc-btn-sm">
      ...
      <div class="emc-card">
        ...
        <form id="emc-upload-form" method="POST" enctype="multipart/form-data" data-tipo="3">

          <div class="emc-dropzone" id="dropzone">
            <input type="file" name="EXCEL_FILE_MEMC_KDX" class="emc-file-input" accept=".xlsx,.xls,.csv" required>
            <i class="fa-solid fa-file-excel fa-2x"></i>
            <div class="dz-title">Arrastra tu archivo aquí o haz clic para seleccionarlo</div>
            <div class="dz-sub">Formatos: <strong>.xlsx</strong> · <strong>.xls</strong> · <strong>.csv</strong>
              &nbsp;·&nbsp; Máx. <?= MAX_SIZE_MB ?> MB</div>
          </div>
          ...
          <div class="emc-link-block" style="margin-top:1.5rem">
            ...
            <textarea id="emc-enlace-input" name="enlace" class="emc-link-input" rows="3"
            ...
            <small class="emc-link-help">
              ...
              Pega el enlace completo o el <strong>código &lt;iframe&gt;</strong> del botón "Insertar / Embed". Se
          ...
          <div class="emc-file-select-row d-flex justify-content-center align-items-center gap-3"
