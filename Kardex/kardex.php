...
//     exit;
// }
require_once(__DIR__ . "/Kardex/Verkardex/LogicaVerKardex.php");
...
<body>
  ...
  <div class="container p-4">
    <h5 class="tittlecont">Consulta de datos 'Kárdex'</h5>
    <br /><br />
    ...
    <div style="float:left" class="row">
      <div class="col-20">
        <small class="alert alert-info">
          ...
          Desde esta sección consulta el archivo de 'Kárdex'
        </small>
      </div>
    </div>
    <br />
