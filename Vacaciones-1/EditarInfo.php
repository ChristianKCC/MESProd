        ...
        <div class="campos">
            ...
            <div>
                ...
                <div class="campo-grupo fila-inline">
                    <!-- <label>DE: </label> -->
                    <input hidden type="date" id="vacaciones_de" name="vacaciones_de" value="<?= htmlspecialchars($vacaciones_por) ?>" style="max-width:80px">
                    <!-- <label>DEL 20: </label> -->
                    ...
                    <input type="date" id="vacaciones_hasta" name="vacaciones_hasta" value="<?= htmlspecialchars($vacaciones_hasta) ?>">
                </div>
            ...
            <div>
                ...
                <div class="campo-grupo fila-inline">
                    <!-- <label>DE: </label> -->
                    <input hidden type="date" id="periodo_de" name="periodo_de" style="max-width:80px" value="<?= htmlspecialchars($vacaciones_por) ?>">
                    <!-- <label>DEL 20: </label> -->
