...
$pdf->Cell(15, 5, utf8_decode("TOTAL"), 1,0,'L',0);
$pdf->Cell(10, 5, utf8_decode("+60.5"), 1, 0, 'L', 0);
$pdf->SetXY(225,35);
$pdf->Cell(15, 5, utf8_decode("HORAS"), 1,0,'L',0);
...
while ($rowal = sqlsrv_fetch_array($resultal)) {
    ...
    //$pdf->Cell(10, 5, utf8_decode($tipo60), 1, 0, 'C', 0);
...
// Mostrar en el PDF
$pdf->Cell(15, 5, $totalGeneralFormateado, 1, 0, 'C', 0);
$pdf->Ln(20);
