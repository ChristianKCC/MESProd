...
const EMC_TIPO_EXCEL_PDT = 5;   // Kardex
...
const EMC_EMBED_PARAMS_EXCEL_PDT =
    'action=embedview'
...
function paramsPorTipo($tipo)
{
    switch ((int) $tipo) {
        ...
        case EMC_TIPO_EXCEL_PDT:
            return EMC_EMBED_PARAMS_EXCEL_PDT;
        default:
            return EMC_EMBED_PARAMS_EXCEL_PDT;
    }
}
 ...
 * @return string|null
 */
function construirEnlaceEmbed($enlaceBase, $tipo = EMC_TIPO_EXCEL_PDT)
{
