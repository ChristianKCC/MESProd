...
<div class="container p-4">
    <h5 class="tittlecont">Autorización de Tiempo Extra</h5>
    ...
    <div style="float-left" class="row">
        <div class="col-20">
            <small class="alert alert-info" style="float:left">
                ...
                Desde esta seccion aprueba o rechaza las solicitudes correspondientes a tiempos extras
            </small>
        </div>
    </div>
...
<script type="module" src="js/folios.js"></script>