...
class TExtra {
  ...
  async enviar(id, autor) {
    const respuestaraw = await fetch(
      "./php/index.php?updateTE&id=" + id + "&autor=" + autor,
    );
    const respuesta = await respuestaraw.json();
...
function colocarHrsbyTurno() {
  ...
  if (turn === "turno1") {
    ...
    document.getElementById("horaFinTurno").value = "15:00:00";
  } else if (turn === "turno1_12hrs") {
    document.getElementById("horaInicioTurno").value = "07:00:00";
    document.getElementById("horaFinTurno").value = "19:00:00";
  } else {
  ...
  .addEventListener("click", async () => {
    ...
    if (result.success) {
      ...
      bootstrap.Modal.getInstance(
        document.getElementById("modalEditarTE"),
      ).hide();
    } else {
  ...
  const steps = [
    {
      ...
      popover: {
        ...
        description:
          "Aquí podrás validar la información en las solicitudes de tiempo extra.",
        side: "bottom",
      },
    },
    {
      ...
      popover: {
        title: "Instrucciones",
        description:
          "Valida la información del empleado antes de enviarla a autorización de Gerencia.",
        side: "bottom",
      },
    },
    {
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          "Usa este filtro para mostrar solo las solicitudes de un folio específico.",
        side: "top",
      },
    },
    {
      ...
      popover: {
        ...
        description:
          "Haz clic aquí para quitar filtros y mostrar todas las solicitudes.",
        side: "top",
      },
    },
    {
      ...
      popover: {
        ...
        description:
          "Aquí se muestran los campos de cada solicitud: folio, empleado, horarios, motivos y acciones.",
        side: "top",
      },
    },
    {
      ...
      popover: {
        ...
        description:
          "En esta tabla se cargan las solicitudes según los filtros aplicados.",
        side: "top",
      },
    },
    {
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          "Haz clic para avanzar a la siguiente página de registros.",
        side: "top",
      },
    },
    {
      ...
      popover: {
        ...
        description:
          "Presiona este botón para repetir el tutorial de la pantalla.",
        side: "left",
      },
    },
  ];
  ...
  const stepsModal = [
    {
      ...
      popover: {
        ...
        description:
          "Este formulario permite modificar y validar una solicitud de tiempo extra.",
        side: "bottom",
      },
    },
    {
      ...
      popover: {
        ...
        description:
          "Modifica la información necesaria y presiona 'Actualizar y Validar Tiempo Extra' en caso de ser APTO, o 'Eliminar registro' en caso de NO SER APTO.",
        side: "top",
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          "Haz clic aquí para actualizar y validar la solicitud como apta.",
        side: "top",
        popoverClass: "popover-importante",
      },
    },
    ...
    },
    {
      ...
      popover: {
        title: "Botón de ayuda",
        description:
          "Presiona este botón para repetir el tutorial del formulario.",
        side: "left",
      },
    },
  ];
