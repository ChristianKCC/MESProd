...
$Verificarsesion->esEnSuperIntendentes();
...
<div class="container p-4">
    <h5 class="tittlecont">Pre-autorización de Solicitudes de Tiempo Extra</h5>
    ...
    <div style="float-left" class="row">
        <div class="col-20">
            <small class="alert alert-info" style="float:left">
                ...
                Desde esta seccion aprueba o rechaza las solicitudes correspondientes a tiempos extras como Super
                Intendente
            </small>
        </div>
    </div>
    ...
    <div class="card card-body">
        <div class="row mb-3">
            ...
            <div class="col">
                <button class="btn btn-primary " onclick="window.Folios.consulta()"> <i class="fa-solid fa-filter"></i>
                    Filtrar</button>
            </div>
        </div>
        ...
        <!-- <ul class="nav nav-tabs mb-3" id="foliosTabs" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="procesadas-tab" data-bs-toggle="tab" data-bs-target="#procesadas"
                    type="button" role="tab">
            ...
            <div class="tab-pane fade show active" id="pendientes" role="tabpanel">
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody id="tblFoliosPendientes"></tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="procesadas" role="tabpanel">
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody id="tblFoliosProcesadas"></tbody>
                    </table>
                </div>
            </div>
            ...
            <div class="tab-pane fade" id="rechazadas" role="tabpanel">
                <div class="table-responsive">
                    <table class="table table-sm">
                        ...
                        <tbody id="tblFoliosRechazadas"></tbody>
                    </table>
                </div>
            </div>
...
<script type="module" src="js/foliosSupInt.js"></script>