...
<link rel="stylesheet" href="css/multidia.css">
...
<div class="container p-4">
    ...
    <div class="row">
        ...
        <?php
                ...
                if (!isset($_SESSION['ibm']) || $_SESSION['ibm'] === 58998 || $_SESSION['ibm'] === 51947 || $_SESSION['ibm'] === 55268 || $_SESSION['ibm'] === 53224 || $_SESSION['ibm'] === 55075 || $Verificarsesion->esEnSupervisoresValidar() || obtenerSupervisoresIBM()) {
                ?>
                    <div class="col"><br />
    ...
    <form id="formtiempoextra" class="border m-2 p-2 rounded">
        ...
        <div class="row my-2">
            ...
            <div class="col">
                <small id="labelrazon" name="labelrazon">Razon del tiempo extra</small>
    ...
    <!-- ── TOGGLE MODO INDIVIDUAL / MÚLTIPLE ─────────────────────────────────── -->
    <div class="toggle-modo-wrap">
        <label class="switch">        
        <input type="checkbox" id="toggleModoMultiple" onchange="toggleModoMultiple(this)">
            <span class="slider"></span>
        </label>
        <label for="toggleModoMultiple">
            Captura múltiple
            <span class="badge bg-white text-dark badge-modo ms-1">hasta 7 días maximo</span>
        </label>
        <small class="">
            — activa para registrar varios días a la vez
        </small>
    </div>

    <!-- ── PANEL MÚLTIPLE (oculto por defecto) ────────────────────────────────── -->
    <div id="panelMultidiaWrap" style="display:none;">
        <div id="panelMultidia"></div>
    </div>
                    ...
                    <div class="doc-layout">
                        ...
                        <div class="doc-main">
                            ...
                            <div class="doc-body">
                                ...
                                <input type="hidden" name="ibm_empleado" id="ibm_empleado">
                                ...
                                <div class="row">
                                    <div class="campo grow">
                                        ...
                                        <div class="campo grow">
                                            <input class="inp" type="text" name="nombre_receptor" id="nombre_receptor" placeholder="Nombre del empleado">
                                        </div>
                                        <!-- <span class="lbl"> IBM empleado: </span>
                                        <div class="campo grow">
                                            <input class="inp" type="text" name="ibmCTT" id="ibmCTT" placeholder="IBM del empleado">
                                        </div> -->
                                    </div>
                                    <div class="campo grow">
                                        <span class="lbl">De:</span>
                                        <input class="inp" type="text" name="de_area" id="de_area" placeholder="Nombre de supervisor" value="<?php echo htmlspecialchars($_SESSION['nombreFull']); ?>">
                                        <!-- <span class="lbl">IBM supervisor:</span>
                                        <input class="inp" type="text" name="ibmSCTT" id="ibmSCTT" placeholder="IBM de supervisor" value="<?php echo htmlspecialchars($_SESSION['ibm']); ?>"> -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="campo grow">
                                        ...
                                        <input class="inp" type="text" name="hasta_tripulacion" id="hasta_tripulacion" placeholder="Tripulacion ..." value="" >
                                    </div>
                                </div>
                                ...
                                <div class="horario-box">
                                    <div class="h-col">
                                        ...
                                        <div class="row" style="margin-bottom:0; align-items:flex-end;">                                            
                                            ...
                                            <!-- <div class="campo grow">
                                                ...
                                                <input hidden class="inp" type="time" name="hora_presentacion" id="hora_presentacion" value="01:00:00">
                                            <!-- </div> -->
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="h-col">
                                        ...
                                        <div class="campo grow">
                                            <span class="lbl"> De: </span> -->
                                            <!-- <input hidden class="inp" type="text" name="hasta_tripulacion" id="hasta_tripulacion" placeholder="Ej: Nombre" value="" > -->
                                            <input hidden class="inp" type="text" name="rol" id="rol" placeholder="Rol ...">
                                        <!-- </div>
                                    </div> -->
                                </div>
                                ...
                                <div class="sub-box">
                                    <div class="row" style="margin-top:5px;">
                                        ...
                                        <div class="campo grow">
                                            ...
                                            <input class="inp" type="text" name="horario_adicional" id="horario_adicional" placeholder="Continua en esta linea">
                                        </div>
                                    </div>
                                </div>
...
<script src="js/multidia.js"></script>