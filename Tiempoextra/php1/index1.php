...
class Tiempoextra
{
    ...
    function tblenc()
    {
        ...
        $ibmsAccesoTotal = ["58998","51947","55268","53224"];

        // Condición dinámica
        $whereSupervisor = in_array($ibm, $ibmsAccesoTotal) 
            ? "" 
            : "WHERE TiempoextraEnc.supervisor = '" . $ibm . "'";
        ...
        INNER JOIN TLX009MXDB.dbo.tblDepartamentos 
            ON tblDepartamentos.NoDepto = TiempoextraEnc.departamento 
        $whereSupervisor
...
class Reportes
{
    ...
    function tblautorizatp()
    {
        ...
        else if($ibm == '51947' || $ibm == '53224' || $ibm == '55268'){
            $where = "";
            $params = [];
        } 
        else {
