    ...
    for (let i = 0; i < selectMotivos.options.length; i++) {
        ...
        if (opt.value === "9" || opt.value === "8") {
            if (tipo === "empleado") {
                ...
                if (selectMotivos.value === "9" || selectMotivos.value === "8") selectMotivos.value = "";
    ...
    const steps = [
        ...
        },
        {
            ...
            popover: {
                ...
                description: "Activa este interruptor para cambiar al modo de captura múltiple. Te permite registrar tiempos extra de varios días de la semana a la vez (hasta 7),  cada uno con su propia configuración,  en lugar de capturar uno por uno. Necesitas tener un folio creado o seleccionado primero.",
                side: "top",
                popoverClass: "popover-importante"
            }
        },
