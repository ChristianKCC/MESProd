...
class Tiempoextra {
  ...
  async cargarTabla() {
    ...
    try {
      const response = await fetch(
        "php/index.php?tblCambiosTurnoIndependientes",
      );
  ...
  async eliminarCambio(id) {
    ...
    try {
      const response = await fetch("php/index.php?eliminarCambioTurno", {
        method: "POST",
        body: data,
      });
  ...
  async guardarCambio() {
    const hora_presentacion = document
    ...
    const hasta_tripulacion = document
      .getElementById("hasta_tripulacion")
      .value.trim();
    const nombre_receptor = document
      .getElementById("nombre_receptor")
      .value.trim();
    ...
    try {
      const response = await fetch("php/index.php?guardarCambioTurno&folio=", {
        method: "POST",
        body: data,
      });
      const result = await response.json();
      ...
      if (result.success) {
        Swal.fire(
          "Guardado",
          "El cambio temporal de turno fue registrado correctamente.",
          "success",
        );
...
document
  .getElementById("btnGuardarCambio")
  ...
  const steps = [
    {
      ...
      popover: {
        ...
        description:
          "Desde aquí puedes registrar cambios temporales de turno sin necesidad de asociarlos a un tiempo extra.",
        side: "bottom",
      },
    },
    {
      ...
      popover: {
        ...
        description:
          "Fecha en que se emite este cambio. Se llena automáticamente con la fecha de hoy.",
        side: "top",
      },
    },
    {
    ...
    },
    {
      ...
      popover: {
        title: "Supervisor",
        description:
          "Nombre del supervisor que autoriza el cambio. Se llena automáticamente.",
        side: "top",
      },
    },
    {
    ...
    },
    {
      ...
      popover: {
        title: "Descansos",
        description:
          "Especifica los descansos aplicables al nuevo turno si corresponde.",
        side: "top",
      },
    },
    {
    ...
    },
    {
      ...
      popover: {
        ...
        description:
          "Limpia todos los campos del formulario para comenzar un nuevo registro.",
        side: "top",
      },
    },
    {
      ...
      popover: {
        ...
        description:
          "Aquí aparecerán todos los cambios temporales de turno creados desde esta vista.",
        side: "top",
        popoverClass: "popover-importante",
      },
    },
