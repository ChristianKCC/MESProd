...
Incidenciaobj.tblEncabezado().then((element) => {
  ...
  element.forEach((dataelement) => {
    body += `
         <div class="col-3 border rounded shadow-sm p-2 bg-white">
          ...
          <span>Clasificación:  ${
            dataelement.total >= 0 && dataelement.total <= 5
              ? "Riesgo Aceptable"
              : dataelement.total > 5 && dataelement.total <= 50
              ? "Riesgo bajo pero significativo"
              : dataelement.total > 50 && dataelement.total <= 500
              ? "Riesgo alto"
              : dataelement.total > 500
              ? "Riesgo Inaceptable"
              : "No evaluado"
          }</span><br>
          ...
          <p><a href="#" class="btn text-white form-control btn-sm my-2" style="background:#0096c7;" data-bs-toggle="modal" data-bs-target="#modaletapa3" data-bs-whatever="${
            dataelement.id
          }"><i class="fa-solid fa-magnifying-glass"></i> Etapa 3</a>
          <a href="#" class="btn text-white form-control btn-sm my-2" style="background:#0077B6;" data-bs-toggle="modal" data-bs-target="#modaletapa4" data-bs-whatever="${
            dataelement.id
          }"> <i class="fa-solid fa-triangle-exclamation"></i> Etapa 4</a>
          <a href="#" class="btn text-white form-control btn-sm my-2" style="background:#023E8A;" data-bs-toggle="modal" data-bs-target="#modaletapa5" data-bs-whatever="${
            dataelement.id
          }"><i class="fa-solid fa-people-carry-box"></i>  Etapa 5</a>
          <a href="#" class="btn text-white form-control btn-sm my-2" style="background:#021E9A;" data-bs-toggle="modal" data-bs-target="#modaletapa6" data-bs-whatever="${
            dataelement.id
          }"><i class="fa fa-hand-pointer"></i>  Etapa 6</a>
          <a href="#" class="btn text-white form-control btn-sm my-2" style="background:#021E9A;" data-bs-toggle="modal" data-bs-target="#modaletapa7" data-bs-whatever="${
            dataelement.id
          }"><i class="fa-solid fa-clipboard"></i>  Etapa 7</a>
          <a href="#" class="btn text-white form-control btn-sm my-2" style="background:#021E9A;" data-bs-toggle="modal" data-bs-target="#modaletapa8" data-bs-whatever="${
            dataelement.id
          }"><i class="fa fa-check-circle"></i>  Etapa 8</a></p>
          <div class="row m-2">
            <div class="col-8">
              ...
              ${
                dataelement.lvlAutoriza === 3
                  ? `<button class="btn btn-sm btn-warning" onclick="editBtnE1(${dataelement.id})">
                    <i class="fas fa-edit"></i> Editar</i></button>
                    <button class="btn btn-sm btn-danger" onclick="deleteBtnE1(${dataelement.id})">
                    <i class="fas fa-trash"></i> Eliminar</i></button>`
                  : `<button class="btn btn-sm btn-warning" hidden>
                    <i class="fas fa-edit"></i> Editar</i>
                  </button>`
              }
            </div>
          </div>
          ...
          body += `
                        <div class="col-3 mx-4 mb-2 border rounded shadow-sm p-2 bg-white">
                          ...
                          <div class="row justify-content-end m-2">
                            <div class="col-6">
                              <button class="btn btn-outline-danger" onclick="generarPDF(${dataelement.id})"><i class="fa-regular fa-file-pdf"></i></button>
...
window.editBtnE1 = (id) => {
  ...
  Incidenciaobj.editEtapa1y2(id).then((element) => {
    ...
    document.getElementById("imgPreview").src = "CapaSeg/" + element[0].ruta;
...
window.deleteBtnE1 = (id) => {
  Incidenciaobj.elimarRegistroIncidencia(id);
};
