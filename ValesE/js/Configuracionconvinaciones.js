...
document
  .getElementById("savecombinacion")
...
window.editconvinacionesxid = (param) => {
  confClave.editarConvinaciones(
    param,
    "idconvinacion",
    "maquinaconv",
    "claveconv",
...
document.getElementById("claseinput").addEventListener("input", (e) => {
  ...
  confClave.slcautocomplete(
    ...
    autocompleteclases,
    "claseconv",
    "../ValesE/php/Vales.php?autoclases",
    "claseinput"
  );
});
document.getElementById("materialinput").addEventListener("input", (e) => {
  ...
  confClave.slcautocomplete(
    ...
    "materialconv",
    "../ValesE/php/Vales.php?automateriales",
    "materialinput"
  );
});
