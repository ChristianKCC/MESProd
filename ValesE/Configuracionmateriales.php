...
<div class="container rounded shadow">
    ...
    <div class="row">
        <div class="col"><small>Buscar material</small><input type="text" class="form-control form-control-sm"
                id="materialbusqueda" /> </div>
        <div class="col-1"><br /><button class="btn btn-sm bg-target" id="buscarmaterial"><i class="fas fa-search"></i>
                Buscar</button></div>
        <div class="col-1"><br /><button class="btn btn-sm btn-danger" id="nuevomaterial"><i class="fas fa-plus"></i>
                Nueva Clave</button></div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-2">
                    <div class="col-12"><small>NoMaterial</small><input type="number"
                            class="form-control form-control-sm" id="nomaterial" />
                        <input type="number" class="form-control form-control-sm" id="idmaterial" readonly hidden />
                    </div>
                    <div class="col-12"><small>Nombre Material</small><input type=" text"
                            class="form-control form-control-sm" id="nombrematerial" />
                    </div>
                    <div class="col-6"><small>UMMaterial</small><select class="form-control form-control-sm"
                            id="ummaterial">
                    ...
                    <div class="col-6"><small>Montacargas</small><select class="form-control form-control-sm"
                            id="montacargas">
                            <option value=''>Selecciona una opción</option>
                    ...
                    <div class="col-6"><small>Tiempo</small><input type="number" class="form-control form-control-sm"
                            id="tiempo" /> </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm bg-target" id='savechgmateriales'><i class="fas fa-save"></i>
                    Guardar</button>
            </div>
        </div>
    </div>
