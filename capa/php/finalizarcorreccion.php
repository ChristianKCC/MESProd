...
<form>
	...
	<textarea class="form-control" id="solucion" placeholder="Agrega la descripción de lo que hiciste"></textarea>
		</div>
		<div class="col-4">
	...
	<input type="file" id="archivo" class="form-control" accept="application/pdf">
		...
		<div class="col-4">
		<small>¿Quién va revisar la acción 2?</small>
...
<script type="text/javascript">
	...
	if(data1=="" || data2=="" || data3=="" || data4=="" || files.length==0){
	      $("#errores").html("<div class='alert alert-danger my-2' role='alert'>No puede haber campos vacíos 2.</div>");
	}
	else{
	...
	$.ajax({
		url: 'php/completaraccionmenor.php',
		type: 'POST',
        dataType: "html",
        data: formData,
		cache: false,
	...
	var idac=$("#idaccion").val();
		$.ajax({
			url: 'php/slc.php?validadoresmenor',
			type: 'POST',
			dataType: 'html',
			data: {'idaccion': idac},
		})
