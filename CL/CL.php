...
//     exit;
// }
require_once(__DIR__ . "/CL/VerCL/LogicaVerCL.php");
...
<body>
  ...
  <div class="container p-4">
    <h5 class="tittlecont">Consulta de datos 'Matriz Cumplimiento Legal'</h5>
    <br /><br />
    ...
    <div style="float:left" class="row">
      <div class="col-20">
        <small class="alert alert-info">
          ...
          Desde esta sección consulta el archivo de 'Matriz Cumplimiento Legal'
        </small>
      </div>
    </div>
    <br />
