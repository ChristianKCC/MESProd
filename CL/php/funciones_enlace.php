...
const EMC_TIPO_EXCEL_CL = 7;   // Especifico
...
const EMC_EMBED_PARAMS_EXCEL_CL =
    'action=embedview'
...
function paramsPorTipo($tipo)
{
    switch ((int) $tipo) {
        ...
        case EMC_TIPO_EXCEL_CL:
            return EMC_EMBED_PARAMS_EXCEL_CL;
        default:
            return EMC_EMBED_PARAMS_EXCEL_CL;
    }
}
 ...
 * @return string|null
 */
function construirEnlaceEmbed($enlaceBase, $tipo = EMC_TIPO_EXCEL_CL)
{
