    ...
    <div class="row">
      <div class="col-20">
        <small class="alert alert-info">
          ...
          Sube el archivo <strong>.pptx</strong> del organigrama y pega el <strong>enlace de PowerPoint Online</strong>.
          El archivo y el enlace anteriores serán reemplazados automáticamente.
        </small>
      </div>
    </div>
    <br />
      ...
      <div class="emc-card">
        ...
        <form id="emc-upload-form" method="POST" enctype="multipart/form-data" data-tipo="2">
          ...
          <div class="emc-dropzone" id="dropzone">
            <input type="file" name="pptx_file" class="emc-file-input" accept=".pptx,.ppt" required>
