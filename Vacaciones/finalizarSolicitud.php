        ...
        <div class="campos">
            ...
            <div>
                ...
                <div class="campo-grupo fila-inline">
                    <!-- <label>DE: </label> -->
                    <input hidden type="date" id="vacaciones_de" name="vacaciones_de" value="<?= htmlspecialchars($fechaDe) ?>" style="max-width:80px">
                    <!-- <label>DEL 20: </label> -->
                    <input hidden type="text" id="vacaciones_anio_de" name="vacaciones_anio_de" value="26" style="max-width:50px" placeholder="AA">
                    <label>HASTA EL DIA: </label>
                    <input type="date" id="vacaciones_hasta" name="vacaciones_hasta" value="<?= htmlspecialchars($fecha_a) ?>">
                </div>

                <div class="campo-grupo">
                    <label>DÍAS CORRESPONDIENTES POR ANTIGUEDAD:</label>
                    <input type="number" id="dias_antiguedad" name="dias_antiguedad" value="<?= htmlspecialchars($limite_dias) ?>" min="0" required readonly>
                </div>
            ...
            <div>
                ...
                <div class="campo-grupo fila-inline">
                    <!-- <label>DE: </label> -->
                    <input type="hidden" id="dias_habiles_partir" name="dias_habiles_partir" placeholder="DÍAS HABILES" value="<?= htmlspecialchars($fechaDe) ?>" required>
                    
                    <!-- <label>DEL 20: </label> -->
                    <input hidden  type="text" id="periodo_anio_de" name="periodo_anio_de" style="max-width:35px" value="26" placeholder="AA">                    
                    <label>PERIODO SOLICITADO:</label>
                    <input type="text" id="periodo_solicitado" name="periodo_solicitado" placeholder="PERIODO SOLICITADO" required>
                </div>                
