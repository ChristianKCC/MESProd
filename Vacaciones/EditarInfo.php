...
if (!function_exists('calcularAntiguedad')) {
    ...
    <form id="formEditVac" method="POST" target='_blank'>
        ...
        <div class="page">
                ...
                <div>
                    ...
                    <div class="campo-grupo">
                        ...
                        <input type="text" id="solicitud_por" name="solicitud_por" placeholder="MOTIVO / PERIODO"
                            value="<?= htmlspecialchars($solicitud_por) ?>">
                    </div>

                    <div class="campo-grupo fila-inline">
                        <!-- <label>DE: </label> -->
                        <input hidden type="date" id="vacaciones_de" name="vacaciones_de"
                            value="<?= htmlspecialchars($vacaciones_por) ?>" style="max-width:80px">
                        <!-- <label>DEL 20: </label> -->
                    ...
                    <div class="campo-grupo">
                        ...
                        <input type="number" id="dias_reposicion" name="dias_reposicion" min="0"
                            value="<?= htmlspecialchars($dias_reposicion ?? 0) ?>">
                    </div>


                    <div class="campo-grupo">
                        <label>DÍAS DE DESCANSO:</label>
                        <input type="number" id="dias_descanso" name="dias_descanso"
                            value="<?= htmlspecialchars($dias_descanso ?? 0) ?>">
                    </div>

                    <div class="campo-grupo">
                        <label>TOTAL DE DÍAS:</label>
                        <input type="number" id="total_dias" name="total_dias" min="0"
                            value="<?= htmlspecialchars($total_dias ?? 0) ?>">
                    </div>
                </div>
                ...
                <div>
                    <div class="campo-grupo">
                        ...
                        <input type="text" id="tarjeta" name="tarjeta" placeholder="NO. DE TARJETA"
                            value="<?= htmlspecialchars($tarjeta) ?>">
                    </div>
                    ...
                    <div class="campo-grupo">
                        ...
                        <input type="text" id="antiguedad_de" name="antiguedad_de" placeholder="ANTIGUEDAD DE:"
                            value="<?= htmlspecialchars($antiguedad_de) ?>">
                    </div>

                    <div class="campo-grupo">
                        <label>DÍA(S) HÁBIL(ES) A PARTIR DEL:</label>
                        <input type="text" id="dias_habiles_partir" name="dias_habiles_partir"
                            placeholder="DÍAS HABILES" value="<?= htmlspecialchars($dias_habiles_partir) ?>">
                    </div>

                    <div class="campo-grupo fila-inline">
                        <!-- <label>DE: </label> -->
                        <input hidden type="date" id="periodo_de" name="periodo_de" style="max-width:80px"
                            value="<?= htmlspecialchars($vacaciones_por) ?>">
                        <!-- <label>DEL 20: </label> -->
                        ...
                        <input type="text" id="periodo_solicitado" name="periodo_solicitado"
                            placeholder="PERIODO SOLICITADO" value="<?= htmlspecialchars($periodo_de) ?>">
                    </div>

                    <div class="campo-grupo">
                        <label>TIPO DE SOLICITUD:</label>
                        <input type="text" id="tipo_sol" name="tipo_sol" placeholder="TIPO"
                            value="<?= htmlspecialchars($tipo_solicitud) ?>">
                    </div>
            ...
            <div class="obs-section">
                ...
                <input type="text" id="observaciones" name="observaciones" maxlength="50"
                    placeholder="AGREGA TUS OBSERVACIONES AQUI..." value="<?= htmlspecialchars($observaciones) ?>">
            ...
            <div class="obs-section">
                ...
                <input type="text" id="fechas_reposicion" name="fechas_reposicion" maxlength="50"
                    placeholder="AGREGA TUS FECHAS AQUI..." value="<?= htmlspecialchars($fechasRF) ?>">
            ...
            <div class="saldo-row">
                <div class="saldo-item">
                    ...
                    <input type="text" id="saldo_periodo" name="saldo_periodo"
                        value="<?= htmlspecialchars($saldoPeriodo ?? 0) ?>">
                </div>
                <div class="saldo-item">
                    <label>DÍAS HABILES:</label>
                    <input type="text" id="dias_habiles_saldo" name="dias_habiles_saldo"
                        value="<?= htmlspecialchars($diasHabiles ?? 0) ?>">
                </div>
            </div>
            ...
            <div class="botones">
                <button type="button" class="btn btn-primary" onclick="regresar()">
