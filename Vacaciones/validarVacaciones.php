...
<div class="container p-4">
    ...
    <div style="float-left" class="row">
        <div class="col-20">
            <small class="alert alert-info" style="float:left">
                ...
                Desde esta seccion valida la información del empleado para que sea enviado a firma de Relaciones
                Industriales
            </small>
        </div>
    </div>
    ...
    <div class="card card-body">
        <div class="row mb-3">
            <div class="col">
                <label>Filtra por fecha de registro</label>
            ...
            <div class="col">
                <button class="btn btn-primary" onclick="window.Vacaciones.consulta()"> <i
                        class="fa-solid fa-filter"></i> Filtrar</button>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">
                        <i class="fa-solid fa-calendar-check"></i> Verificación de NO ASISTENCIA en periodo de
                        vacaciones
                    </h5>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" id="primaDomSemana" class="form-control" placeholder="Ej. Semana 28 / 2026-W28">
                </div>
                <div class="modal-footer">
