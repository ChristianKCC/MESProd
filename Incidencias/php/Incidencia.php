...
class Incidencia
{
    ...
    function tblEncabezado()
    {
        $connobj = new ClassConexion();
        $conn = $connobj->conexion("TLX003MXDB");
        $query = "SELECT tblIncidenciasEnc.id,tblIncidenciasEnc.fecha, TLX009MXDB.dbo.tblDepartamentos.NombreDepto, tblProactAreas.NombreArea, tblIncidenciasVersion.Version, tblIncidenciasClasificacion.Clasificacion, tblIncidencias.Incidencia, 
                         tblIncidenciasEnc.descripcion, tblEmpleados_1.Nombre as nombregenero, TLX032MXDB.dbo.tblEmpleados.Nombre AS nombreimplicado, tblIncidenciasAntPuesto.AntPuesto, tblIncidenciasAntEmpresa.AntEmpresa, tblIncidenciasEnc.diasincapacidad, 
                         tblIncidenciasEnc.diastrabajo, tblIncidenciasTipContacto.TipContacto, tblIncidenciasEnc.provoco, tblIncidenciasTipLesion.TipLesion, tblIncidenciasCuerpAfectada.ParCuerp, tblIncidenciasSeveridad.Severidad, 
                         tblIncidenciasProbabilidad.Probabilidad, tblIncidenciasFrecuencia.Frecuencia, tblIncidenciasEnc.numafectados, tblIncidenciasEnc.datacarga
                         ...
                         tblProactAreas ON tblIncidenciasEnc.area = tblProactAreas.Id LEFT JOIN
                         tblIncidenciasVersion ON tblIncidenciasEnc.vesion = tblIncidenciasVersion.id LEFT JOIN
                         tblIncidenciasClasificacion ON tblIncidenciasEnc.clasificacion = tblIncidenciasClasificacion.NoClasificacion LEFT JOIN
                         tblIncidencias ON tblIncidenciasEnc.incidencia = tblIncidencias.NoInci LEFT JOIN
                         tblIncidenciasAntPuesto ON tblIncidenciasEnc.antiguedadpuesto = tblIncidenciasAntPuesto.NoAntPuesto LEFT JOIN
                         tblIncidenciasAntEmpresa ON tblIncidenciasEnc.antiguedadempresa = tblIncidenciasAntEmpresa.NoantEmpresa LEFT JOIN
                         tblIncidenciasTipContacto ON tblIncidenciasEnc.tipocontacto = tblIncidenciasTipContacto.NoTipContacto LEFT JOIN
                         tblIncidenciasTipLesion ON tblIncidenciasEnc.tipolesion = tblIncidenciasTipLesion.NoTipLesion LEFT JOIN
                         tblIncidenciasCuerpAfectada ON tblIncidenciasEnc.parteafectada = tblIncidenciasCuerpAfectada.NoParCuerpo LEFT JOIN
                         tblIncidenciasSeveridad ON tblIncidenciasEnc.severidad = tblIncidenciasSeveridad.NoSeveridad LEFT JOIN
                         tblIncidenciasProbabilidad ON tblIncidenciasEnc.probabilidad = tblIncidenciasProbabilidad.NoProbabilidad LEFT JOIN
                         TLX032MXDB.dbo.tblEmpleados AS tblEmpleados_1 ON tblIncidenciasEnc.noemgenero = tblEmpleados_1.NoEmp LEFT JOIN
                         TLX032MXDB.dbo.tblEmpleados ON tblIncidenciasEnc.noempimplicado = tblEmpleados.NoEmp LEFT JOIN
                         tblIncidenciasFrecuencia ON tblIncidenciasEnc.frecuencia = tblIncidenciasFrecuencia.NoFrecuencia";
    ...
    function tbletapa6()
    {
        ...
        $conn = $connobj->conexion("TLX003MXDB");
        $folioenc = $_GET['folioenc'];
        $query = "SELECT tblIncEnc6.id, tblIncEnc6.sistemagestion, tblIncidenciasElementosTipo.tipoelemento,
                    tblIncEnc6.sistemagestionsub, tblIncidenciasElementos.elemento, 
                    tblIncEnc6.sistemagestionporque, tblIncEnc.NoReporte
                    FROM tblIncidenciasEncEtapa6 tblIncEnc6
                    INNER JOIN tblIncidenciasElementosTipo ON tblIncidenciasElementosTipo.id= tblIncEnc6.sistemagestion
                    INNER JOIN tblIncidenciasElementos ON tblIncidenciasElementos.id= tblIncEnc6.sistemagestionsub
                    INNER JOIN tblIncidenciasEnc tblIncEnc ON tblIncEnc.id = tblIncEnc6.folioenc
                    WHERE folioenc=" . $folioenc;
        $result = sqlsrv_query($conn, $query);
        $array = array();
        while ($row = sqlsrv_fetch_array($result)) {
    ...
    function saveEtapa7(){
        ...
        $query = "INSERT INTO tblIncidenciasEncEtapa7(noemp, folio) VALUES (?, ?)";
        $result = sqlsrv_query($conn, $query, array(
            $noempEtapa7,
            $folioenc
        ));
    ...
    function tblEtapa7(){
        ...
        $query = "SELECT tblIncEnc7.*, tblEmpleados.Nombre AS Nombre, tblDepartamentos.NombreDepto as departamento, 
                    ...
                    INNER JOIN  tblIncidenciasEnc tblIncEnc ON tblIncEnc.id = tblIncEnc7.folio
    ...
    function actualizarEtapa7(){
        ...
        $query = "UPDATE tblIncidenciasEncEtapa7 SET noemp=?, folio=?
                WHERE id=$idEtapa7";
        $result = sqlsrv_query($conn, $query, $array);
        if ($result === false) {
                http_response_code(500);
    ...
    function saveEtapa8(){
        ...
        $query = "INSERT INTO tblIncidenciasEncEtapa8(noemp, tipo, folio) VALUES (?, ?, ?)";
    ...
    function tblEtapa8(){
        ...
        $query = "  SELECT tblIncE8.*, tblEmpleados.Nombre AS Nombre, tblDepartamentos.NombreDepto as departamento, 
                    ...
                    INNER JOIN  tblIncidenciasEnc tblIncEnc ON tblIncEnc.id = tblIncE8.folio
    ...
    function actualizarEtapa8(){
        ...
        $query = "UPDATE tblIncidenciasEncEtapa8 SET noemp=?, tipo=?, folio=?
                WHERE id=$idEtapa8";
        $result = sqlsrv_query($conn, $query, $array);
        if ($result === false) {
                http_response_code(500);
