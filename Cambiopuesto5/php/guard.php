...
class VerificarSesionCambP{
    ...
    // Funcion para buscar a los supervisores en la tabla de CAmbiopuestoEnc
    ...
    function contarCambiosPuesto() {
        ...
        if ($ibm == '58998' || $ibm == '51947') {
            $stmt = "SELECT COUNT(*) AS total FROM TLX003MXDB.dbo.CambiopuestoEnc WHERE estadoTer != 1 OR terminado IS NULL";
