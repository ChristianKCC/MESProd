...
<div class="container p-4">
    ...
    <div class="row">
        ...
        <?php
                ...
                if (!isset($_SESSION['ibm']) || $_SESSION['ibm'] === 58998 || $_SESSION['ibm'] === 51947 || $_SESSION['ibm'] === 55268 || $_SESSION['ibm'] === 53224 || $Verificarsesion->esEnSupervisoresValidar()) {
                ?>
                    <div class="col"><br />
    ...
    <form id="formtiempoextra" class="border m-2 p-2 rounded">
        ...
        <div class="row my-2">
            ...
            <div class="col">
                ...
                <!-- <input type="time" step="1" id="duracionTE" class="form-control form-control-sm" required/> -->
            ...
            <div id="horariosDeTurno" name="horariosDeTurno" class="col card" style="display:none; margin-top:5px;">
                <small><b>HORARIO SEGUN TURNO</b></small>
                <br />
                <label class="text-primary" id="valorTurnoHora"><b>Info</b></label>
            </div>
            <div class="col card" id="contenedorCheckbox" style="display:none; margin-top:5px;">
                <small><code><strong>Activa para un turno de 12 hrs:</code></strong></small>
                <br />
                <input type="checkbox" id="checkboxTurno3"> <small>12 Hrs ?</small>
            </div>        
            ...
            <div class="modal-content">                
                ...
                <form method="POST" id="formCambio" target='_blank'>
                    <div class="doc-layout">
                        ...
                        <div class="doc-main">
                            ...
                            <div class="doc-body">
                                ...
                                <div class="row">
                                    <!-- <div class="campo grow">
                                        <span class="lbl"> Tripulación </span>
                                        <input class="inp" type="text" name="tripulacion" id="tripulacion" placeholder="Conductor" >
                                    </div> -->
                                    <div class="campo grow">
                    ...
                    <div class="modal-footer">
                        ...
                        <!-- <button type="submit" class="btn btn-danger" id="btnPDF" disabled>
