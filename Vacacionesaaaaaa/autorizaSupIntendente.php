...
<div class="container p-4">
    <h5 class="tittlecont">Pre-autorización de Solicitudes de Vacaciones</h5>
    ...
    <div style="float-left" class="row">
        <div class="col-20">
            <small class="alert alert-info" style="float:left">
                ...
                Desde esta seccion aprueba o rechaza las solicitudes correspondientes de vacaciones como Super
                Intendente
            </small>
        </div>
    </div>
