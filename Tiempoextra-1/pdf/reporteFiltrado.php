...
function renderFolio($pdf, $conn, $folio, $condEmp)
{
    ...
    while ($rowal = sqlsrv_fetch_array($resultal)) {
        ...
        while ($row = sqlsrv_fetch_array($resultDet)) {
            ...
            if ($minsInt >= 55) { $horasInt += 1; $minsInt = 0; }
        ...
        if ($totalMinutosEmpleado >= 55) { $totalHorasEmpleado += 1; $totalMinutosEmpleado = 0; }
        elseif ($totalMinutosEmpleado >= 28) { $totalMinutosEmpleado = 30; }
