...
<div class="container p-4">
    <h5 class="tittlecont">Autorización de Tiempo Extra (Super Intendente)</h5>
    ...
    <div class="col-20">
            <small class="alert alert-info" style= "float:left">
                    ...
                    Desde esta seccion aprueba o rechaza las solicitudes correspondientes a tiempos extras como Super Intendente
            </small>
        </div>
    </div>
    ...
    <div class="col">
        <button class="btn btn-primary " onclick="window.Folios.consulta()"> <i class="fa-solid fa-filter"></i> Filtrar</button>
    </div>
    </div>
