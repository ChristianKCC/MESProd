...
class Tiempoextra {
    ...
    //             opt.title = "Tu departamento se selecciona automaticamente";
    //         } else {
    //             opt.disabled = false;
    //             opt.style.color = "";
    ...
    //     // Lista de IBM que pueden ver todas las opciones
    //     const ibmsEspeciales = ["58998  "];

    //     for (let i = 0; i < selectDeptos.options.length; i++) {
    //         const opt = selectDeptos.options[i];

    //         if (ibmsEspeciales.includes(ibmUsuario)) {
    //             // IBM especial → todas las opciones habilitadas
    //             opt.disabled = false;
    //             opt.style.color = "";
    //             opt.style.backgroundColor = "";
    //             opt.title = "";
    //         } else {
    //             // IBM normal → restringir a su departamento
    //             if (opt.value !== claveDepto) {
    //                 opt.disabled = true;
    //                 opt.style.color = "#aaa";
    //                 opt.style.backgroundColor = "#f0f0f0";                
    ...
    async getinfoemp(noemp) {
        ...
        const departamentoCompararTexto = selectDepto.options[selectDepto.selectedIndex].text;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const stepsModal = [
        ...
        },
        {
            ...
            popover: {
                title: "Horario",
                description: "Aquí debes seleccionar el rol en el que te encuentras actualmente.",
                side: "top"
            }
        },
        // {
