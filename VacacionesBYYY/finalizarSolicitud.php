        ...
        <div class="col-20">    
            <small class="alert alert-warning">
             <svg 
                ...
                <strong>IMPORTANTE: SOLO PUEDES EDITAR LOS DÍAS SELECCIONADOS, SI INTENTAS AGREGAR UN DIA NUEVO DESDE AQUI NO SE CONTEMPLARA, DEBES SELECCIONARLO DE NUEVO CON EL BOTON 'REGRESAR A LA SOLICITUD'</strong>
            </small>
        </div>
    </div>
    <br>    
        ...
        <div class="campos">
            ...
            <div>
                ...
                <div class="campo-grupo">
                    ...
                    <input type="date" id="fecha_ingreso" name="fecha_ingreso" value="<?= htmlspecialchars($fecha_ingreso) ?>" required>
                </div>
