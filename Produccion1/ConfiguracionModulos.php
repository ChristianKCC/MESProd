...
<div class="container rounded shadow p-4">
    ...
    <div class="row">
        <div class="col">
            <form>
                <div class="row mb-2">
                    <div class="col-8"><small>Buscar Modulo</small><input type="text" class="form-control form-control-sm" id="moduloBusqueda" /> </div>
                    <div class="col-2"><br />
                        <center>
                    ...
                    <div class="col-2"><br />
                    <center>
                        <button class="btn btn-sm btn-danger" id="nuevaModulo"><i class="fas fa-plus"></i> Nuevo Modulo</button>
                    </center>
                    </div>
                </div>
            </form>
...
<div class="modal fade" id="modalNuevoModulo" tabindex="-1" aria-labelledby="modalSeccioneslabel1" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalSeccioneslabel1">Nuevo Modulo</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="row">
