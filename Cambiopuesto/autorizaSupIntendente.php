...
$Verificarsesion = new VerificarSesionCambP();
...
<div class="container p-4">
    <h5 class="tittlecont">Pre-autorización de Solicitudes de Cambios de Puesto (Super Intendente)</h5>
    ...
    <div class="col-20">
            <small class="alert alert-info" style= "float:left">
                    ...
                    Desde esta seccion aprueba o rechaza las solicitudes de cambios de puesto como Super Intendente
            </small>
        </div>
    </div>
    ...
    <div class="row mb-3">
    <div class="col">
        <label>Filtra por fecha de inicio</label>
    ...
    <div class="col">
        <button class="btn btn-primary" onclick="window.Folios.consulta()">Filtrar</button>
    </div>
    </div>

    <ul class="nav nav-tabs mb-3" id="cambioPuestoTabs" role="tablist">
...
<script type="module" src="js/cambiopuestoSupInt.js"></script>
