...
<div class="container p-4">
    <h5 class="tittlecont">Autorización de cambios de puesto (Gerente)</h5>
    ...
    <div class="col-20">
            <small class="alert alert-info" style= "float:left">
                    ...
                    Desde esta seccion aprueba o rechaza las solicitudes correspondientes de cambios de puesto
            </small>
        </div>
    </div>
...
<script type="module" src="js/cambiopuesto.js"></script>
