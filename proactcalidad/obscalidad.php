...
<div class="container p-3">
    <h5 class="tittlecont">Observación de calidad</h5>
    ...
    <form id="formproact" name="formproact">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <div class="d-flex">
                    <!-- <label class="form-check-label" for="deacuerdo" style="font-size:16px">¿Cumple? </label>
                    <span class="mx-1"> No</span>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="cumple" name="cumple">Si
                    </div> -->
