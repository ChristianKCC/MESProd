...
// Accion al modal de edicion
document.getElementById("btnActualizarArchivo").addEventListener("click", () => platicas5min.updateArchivo());

window.deletePlatica = (data) => platicas5min.deletePlatica(data);

// Exposicion global de platica5min
window.platicas5min = platicas5min;