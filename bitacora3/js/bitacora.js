...
class Bitacorastart {
  ...
  _renderHistorial() {
    ...
    // Guard: si no hay historial o no es un array, no intentar renderizar
      ...
      tbody.insertAdjacentHTML(
        ...
        `
          <tr>
            <td>${item.noBajada || ""}</td>
            <td>${item.bobinas || ""}</td>
            <td>${item.kgTotal?.toFixed(2) || ""}</td>
            <td>${item.mlBajada?.toFixed(2) || ""}</td>
            <td>${item.mm2Bajada?.toFixed(2) || ""}</td>
            <td>${item.kgMerma?.toFixed(2) || ""}</td>
          </tr>
        `,
      );
    });
