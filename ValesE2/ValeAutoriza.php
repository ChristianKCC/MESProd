...
<div class="container p-3">
    <h5 class="tittlecont">Revisión vales electrónicos</h5>
    <div class="row">
        <div class="col-2">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalenvLabel">Actualizar Información <span id="folioencvista"></span></h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row" id="formaddmat" style="display: none;">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning btn-sm" id="validaenvio"><i class="fa-regular fa-paper-plane"></i> Validar Envio</button>
                </div>
            </div>
        </div>
    </div>
...
<script type="module" src="js/valesautoriza.js"></script>
</body>
