    ...
    <div class="d-flex align-items-center mb-4 gap-3">
        ...
        <div class="header-vacaciones-consulta">
            <div class="row">
                ...
                <div class="col-4 busquedaNOMBRE">
                    ...
                    <div class="card mb-3 card-datainfo">
                        ...
                        <div class="card-body py-4">
                            <div class="row g-4">
                                ...
                                <div class="col-6">
                                    <div class="dato-label">Fecha de ingreso:</div>
                                    <div class="dato-valor"><code><?= col($empleado, COL_FINGRESO) ?></code></div>
                                </div>
                                <div class="col-6">
                                    <div class="dato-label">Antigüedad:</div>
                                    <div class="dato-valor"><code><?= calcularAntiguedad(col($empleado, COL_FINGRESO)) ?></code></div>
                                </div>
                            </div>
                        </div>
                    </div>
