    ...
    <form id="formVac" action="./pdf/generar_pdf.php" method="POST" target='_blank'>
        ...
        <div class="campos">
            ...
            <div>
                ...
                <div class="campo-grupo fila-inline">
                    <!-- <label>DE: </label> -->
                    <input hidden  type="date" id="periodo_de" name="periodo_de" style="max-width:80px" value="<?= htmlspecialchars($fechaDe) ?>">
                    <!-- <label>DEL 20: </label> -->
                    ...
                    <!-- value="<?= htmlspecialchars($anio) ?> - <?= htmlspecialchars($anioS)?>" -->
